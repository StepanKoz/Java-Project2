...
@Getter
@Configuration
@MapperScan(basePackages = {"com.lesson.learn.repository.write","com.lesson.learn.repository.read"})
public class DataConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryWrite() throws Exception {
        ...
        sqlSessionFactory.setTypeAliasesPackage("com.lesson.learn.entity");

        List<String> mappers = new ArrayList<>();
        mappers.add("classpath*:com/lesson/learn/repository/write/*.xml");
        mappers.add("classpath*:com/lesson/learn/repository/read/*.xml");
